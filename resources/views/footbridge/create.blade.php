                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-offset-2 col-md-4 form-group" >
                            ...
                            <input class="form-control" type="text" name="latitude" pattern="^(\-?\d+(\.\d+)?)$" placeholder="-99.23752" value="{{ old('latitude') }}"  >
                        </div>
                        <div class="col-md-4 form-group">
                            <label for="length" class="control-label">Longitud</label>
                            <input class="form-control" type="text" name="length" pattern="^(\-?\d+(\.\d+)?)$" placeholder="10.23094" value="{{ old('length') }}" >
                        </div>
                    </div>
                </div>
            </div>
