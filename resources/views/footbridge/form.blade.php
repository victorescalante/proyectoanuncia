                ...
                <div id="collapse1" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="availability" class="control-label">Disponibilidad</label><span
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" name="description" id="description" cols="10" rows="10"
                                          placeholder="Coloca una breve descripción ...">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="collapse3" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="municipality" class="control-label">Municipio:</label><span
                                            class="text-danger"> (requerido) </span>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 form-group">
                                ...
                                <input class="form-control" type="text" name="position" placeholder="Frontal"
                                       value="{{ old('position') }}">
                            </div>
                            <div class="col-md-8">
                                <label for="views">Vistas</label>
                                <input class="form-control" type="text" name="views" placeholder="Norte y Sur"
                                       value="{{ old('views') }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input class="form-control" type="text" name="frontal" placeholder="43.5 x 6 mts"
                                       value="{{ old('frontal') }}">
                            </div>
                            <div class="col-md-4">
                                <label for="crusade">Cruzada</label>
                                <input class="form-control" type="text" name="crusade" placeholder="43.5 x 6 mts"
                                       value="{{ old('crusade') }}">
                            </div>
                            <div class="col-md-4">
                                <label for="mega">Mega</label>
                                <input class="form-control" type="text" name="mega" placeholder="43.5 x 6 mts"
                                       value="{{ old('mega') }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input class="form-control" type="text" name="side" placeholder="43.5 x 6 mts"
                                       value="{{ old('side') }}">
                            </div>
                            <div class="col-md-8">
                                <label for="street">Avenida</label>
                                <input class="form-control" type="text" name="street"
                                       placeholder="Bulevard Ávila Camacho / Plaza Satélite"
                                       value="{{ old('street') }}">
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <textarea class="form-control" type="text" name="reference_c"
                                          rows="3">{{ old('reference_c') }}</textarea>
                            </div>
                            <div class="col-md-4">
                                <label for="reference_n">Referencia Norte</label>
                                <textarea class="form-control" type="text" name="reference_n"
                                          rows="3">{{ old('refenrece_n') }}</textarea>
                            </div>
                            <div class="col-md-4">
                                <label for="reference_s">Referencia Sur</label>
                                <textarea class="form-control" type="text" name="reference_s"
                                          rows="3">{{ old('reference_s') }}</textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <label for="reference_o">Referencia Oriente</label>
                                <textarea class="form-control" type="text" name="reference_o"
                                          rows="3">{{ old('reference_o') }}</textarea>
                            </div>
                            <div class="col-md-4">
                                <label for="reference_p">Referencia Poniente</label>
                                <textarea class="form-control" type="text" name="reference_p"
                                          rows="3">{{ old('reference_p') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
